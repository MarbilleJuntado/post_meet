...
#
#     PHX_SERVER=true bin/post_meet start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :post_meet, PostMeetWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :post_meet, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :post_meet, PostMeet.Mailer,
